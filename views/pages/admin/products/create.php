...
?>
    <div class="container admin-form" style="padding: 10rem 0">
        <div class="row">
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header text-center"><h3><?= $editMode ? 'Edit Product' : 'Create Product'; ?></h3></div>
                    <div class="card-body">
                        <form action="/" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="type" value="><?= $editMode ? 'edit_product' : 'create_product'; ?>">
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="file" name="image" value="" required id="formFile" accept="image/jpeg, image/png, image/jpg">
                                <output></output>
                            </div>
